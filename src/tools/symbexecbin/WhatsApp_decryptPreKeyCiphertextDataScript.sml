...
val _ = new_theory "WhatsApp_decryptPreKeyCiphertextData";

val arch_str         = "arm8";

val dafilename = "disassembly_decryptPreKeyCiphertextData:forSignalAddress:plaintextData:.da";
...
(* val _ = save_thm ("WhatsApp_decryptPreKeyCiphertextData_thm", thm); *)
