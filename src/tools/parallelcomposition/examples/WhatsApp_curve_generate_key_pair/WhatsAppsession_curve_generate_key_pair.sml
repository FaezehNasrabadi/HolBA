...
open wordsSyntax;
 ...
 val ERR      = Feedback.mk_HOL_ERR "WhatsAppsession_curve_generate_key_pair"
 val wrap_exn = Feedback.wrap_exn   "WhatsAppsession_curve_generate_key_pair"
...
val lbl_tm = ``BL_Address (Imm64 0xED4B38w)``;

val stop_lbl_tms = [``BL_Address (Imm64 0xED4BA0w)``
		     ];
...
val adr_dict = (bir_symbexec_PreprocessLib.fun_addresses_dict n_dict) handle e => raise wrap_exn "adr_dict" e;
